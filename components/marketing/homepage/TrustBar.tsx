    ...
    <section className="py-12">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 text-center">
        ...
        <div className="flex flex-col items-center">
          <MapPin className="w-12 h-12 text-accent-green mb-3" />
        ...
        {/* Column 2 */}
        <div className="flex flex-col items-center">
          <Users className="w-12 h-12 text-accent-green mb-3" />
          <span className="font-semibold text-primary text-lg">
        ...
        {/* Column 3 */}
        <div className="flex flex-col items-center">
          <ShieldCheck className="w-12 h-12 text-accent-green mb-3" />
          <span className="font-semibold text-primary text-lg">
