    ...
    <section className="py-16 md:py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center mb-24 md:mb-32">
          <div>
            <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold text-primary-blue mb-6 md:mb-8 leading-tight">
        ...
        <div ref={ref} className="relative h-[400px] md:h-[600px] rounded-3xl overflow-hidden shadow-2xl">
          {/* Background Image */}
          <Image
          ...
          <motion.div
            ...
            className="absolute right-6 md:right-12 bottom-6 md:bottom-12 z-10"
          >
            <motion.div
              animate={{ y: [0, -15, 0] }}
          ...
          <div className="absolute inset-0 flex items-center justify-center px-6">
            <div className="max-w-2xl text-center text-white">
              <h2 className="font-display text-2xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6">
