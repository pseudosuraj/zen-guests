      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          <Badge variant="secondary" className="mb-2">
            The Grand Mumbai - Room 204
          </Badge>
          <h1 className="text-3xl font-bold text-gray-900">
            Welcome to Zen-Guests! 🌟
          </h1>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-xl">Connect via WhatsApp</CardTitle>
            <CardDescription>
              Tap below to start chatting with your personal hotel assistant
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500">
                Or continue to your personal portal
              </p>
              <Button 
                variant="outline" 
                className="mt-2"
